...
import com.ramonmr95.app.resources.CarResourceTest;
...
@RunWith(Suite.class)
@SuiteClasses({ CarResourceTest.class, CountryResourceTest.class, BrandResourceTest.class, CarServiceTest.class,
